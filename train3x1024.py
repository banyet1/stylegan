...
if 1:
    ...
    desc += '-ffhq1024';  dataset = EasyDict(tfrecord_dir='ffhq', resolution=1024); train.mirror_augment = True
 ...
 #   desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}
    desc += '-3gpu'; submit_config.num_gpus = 3; sched.minibatch_base = 12; sched.minibatch_dict = {4: 384, 8: 384, 16: 192, 32: 96, 64: 48, 128: 24, 256: 12, 512:12, 1024:12} 
    #desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 258: 8, 512: 8, 1024:4}
    #desc += '-8gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32}

    # Default options.
    train.total_kimg = 25000
    sched.lod_initial_resolution = 8
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.0003}
