...
def main():
    tflib.init_tf()
    _G, _D, Gs = pickle.load(open("/root/styleganface/results/00028-sgan-ffhq1024-3gpu/network-snapshot-012020.pkl", "rb"))
    Gs.print_layers()
    ...
    for i in range(0,3000):
        ...
        images = Gs.run(latents, None, truncation_psi=0.6, randomize_noise=False, output_transform=fmt)
