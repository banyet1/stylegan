...
#url_ffhq        = 'https://a55.org/2019-03-08-stylegan-animefaces-network-02051-021980.pkl'
...
def main():
    ...
    draw_style_mixing_figure(os.path.join(config.result_dir, 'figure03-style-mixing.png'), load_Gs(url_ffhq), w=1024, h=1024, src_seeds=[739,801,787,715,3268], dst_seeds=[888,829,1898,1733,1614,845], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,18)])
